        ...
        <div className={s.root}>
            ...
            <div className={styles.container}>
                <div className={styles.textContainer}>
                    ...
                    <p>
                        If you would like to talk about your order or have any
                        questions about Just by Emma products or brand, I am
                        here to help you.
                    </p>
                </div>
            ...
            <div className={styles.contactContainer}>
                ...
                <div className={styles.socialsContainer}>
                    ...
                    <div className={f.social}>
                        <a
                            href="https://www.facebook.com/people/justbyemma/100069221673666"
                            target="_blank"
                        >
                            <Facebook />
                        </a>
                        <a
                            href="https://www.instagram.com/just.by.emma"
                            target="_blank"
                        >
                            <Instagram />
                        </a>
                ...
                <p className={styles.text}>
                    For direct message please put your details and questions in
                    the lines below.
                </p>
