  ...
  return (
    <>
      ...
      <p>
        ...
        sensitive skin or it created break-out or other sensitive reactions, I just got so confused
        about what I was putting on my skin and I never really knew what ingredients were right for
        my skin type.
        <br />
        After experimenting using more natural product ranges, it led me to venture into a bit of a
        journey myself. I embarked on enrolling and completing some well regarded natural and
        organic skincare formulating courses and started studying, researching and having a go at
        formulating my own products.
        <br />
        Crafting and using these simple formulations really helped to nourish and heal my skin. It
        also inspired me to create and share what is now known as Just by Emma.
        <br />
        I&apos;ve kept it simple for now and have created a basic skincare range that uses gentle,
        natural, plant based oils, essential oils, extracts and some high performing botanical
      ...
      <div className={s.box}>
        ...
        <p>
          ...
          help calm, balance, boost, nourish and give your skin a natural glow.
          <br />
          Directions:
          <br />
          To cleanse, warm a small amount in your hands and then massage, using circular motions,
          into dry skin for around 30 seconds to 1 minute, then gently remove with a warm cloth.
          <br />
          ...
          Directions:
          <br />
          Mix one teaspoon of powder with approximately 1-2 teaspoons of the following for each skin
          type until it forms a smooth paste:
          <br />
          ...
          <br />
          Use a brush to apply to freshly cleansed face and neck area (avoiding eyes). Rinse off
          with warm water after approximately 10 minutes.
          <br />
