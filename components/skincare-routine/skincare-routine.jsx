...
function SkinCareSection() {
  return (
    <div className={s.container}>
      ...
      <div className={s.child}>
        <Image className={s.image} src={PictureTwo} alt="" placeholder="blur" />
      ...
      <div className={s.child}>
        <Image className={s.image} src={PictureThree} alt="" placeholder="blur" />
      ...
      <div className={s.child}>
        <Image className={s.image} src={PictureFour} alt="" placeholder="blur" />
